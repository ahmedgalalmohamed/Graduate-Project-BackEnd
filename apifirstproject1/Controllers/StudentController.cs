    ...
    public class StudentController : Controller
    {
        ...
        public IActionResult Add([FromBody] StudentVM studentModel)
        {
            ...
            StudentsModel student = new()
            {
                ...
                img = ImageConverter.Converter("wwwroot/default-avatar.png"),
            };
        ...
        public IActionResult AddCSV([FromForm] IFormFile readexcel)
        {
            ...
            while (reader.Peek() >= 0)
            {
                ...
                if (found == null)
                {
                    ...
                    DB.Students.Add(new StudentsModel() { Name = std[header.IndexOf("name")], Email = std[header.IndexOf("email")], Password = std[header.IndexOf("password")], Semester = int.Parse(std[header.IndexOf("semester")]), img = image });
                    DB.SaveChanges();
                }
            }
